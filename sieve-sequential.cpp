...
void sieveSequential(int minRange, int maxRange, bool resultMatrix[], int primesMatrix[], int primesCount, int chunkSize){ 
...
int main(int argc, char **argv){
    ...
    cout << "Sito sekwencyjne" << "\n";
    sieveSequential(MIN_RANGE, MAX_RANGE, resultMatrix, primesMatrix, primesCount, chunkSize);
