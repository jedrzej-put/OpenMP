...
void divisonParallelDynamic(int minRange, int maxRange, bool resultMatrix[]) {
#pragma omp parallel 
...
int main(int argc, char **argv){
    ...
    cout << "Modulo rownolegle dynamic" << "\n";
    divisonParallelDynamic(MIN_RANGE, MAX_RANGE, resultMatrix);
